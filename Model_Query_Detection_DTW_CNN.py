...
class ClassifierCNN(nn.Module):
	...
	def forward(self, x):
		...
		x = F.relu(self.dout_layer2d(self.conv5(x)))
		x = F.relu(self.maxpool(self.dout_layer2d(self.conv6(x))))
		x = F.relu(self.dout_layer2d(self.conv7(x)))
		x = F.relu(self.maxpool(self.dout_layer2d(self.conv8(x))))
